...
/**
 * 스프링 MCV에서 제공하고 있는 어노테이션을 이용하여 Controller를 작성해봅시다.
 * 
 * 톰캣 서버를 실행하면 web.xml파일의 설정을 읽어 서버를 시작합니다.
 * web.xml파일에 기술되어 있는
 * servlet-context.xml파일의
 * component-scan에 등록된 패키지를 탐색하여 클래스를 조사하고 
...
public class MappingController {
	 ...
	 * 
	 * get 방식과 post 방식을 모두 처리하고 싶은 경우, 배열로 받을 수 있습니다.
	 * 
	 * /mapping/requestMapping URI를 GET메서드로 호출하면 해당 메서드가 실행됩니다. 
	 */
	 ...
	 * 어노테이션 사용이 불가능 할 경우 스프링의 버전을 확인합니다.
	 *  ✨GetMapping
	 *  Get방식의 요청을 처리합니다.
	 *  
	 *  ✨파라메터의 자동수집
	 ...
	 *  
	 *  VO객체를 지정 할 경우, 객체를 생성 후 파라메터의 name속성과 일치하는 필드에 세팅해줍니다.
	 *  단, 타입이 불일치 하는 경우 400 오류가 발생할 수 있습니다.
	 */
	...
	/**
	 * 파라메터를  Vo, Dto에 수집한 경우, 별도의 저장없이 화면까지 전달됩니다.
	 * 
	 * 화면에 값을 전달하고 싶은 경우
	 * Model객체를 매개변수로 받아 속성을 추가합니다.
